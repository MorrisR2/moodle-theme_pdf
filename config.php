...
/**
 * Configuration for the Render-to-PDF Theme
 *
 * THIS IS NOT A TRUE THEME! 
 * DO NOT SET THIS THEME AS YOUR MAIN MOODLE THEME.
 *
 * @package   theme_pdf
...
// Hide the theme from the theme selector when not in theme designer mode.
